...
- Vendored path: `core/finetune/optim/amuse.py`
...
optimizer source required by this project is vendored; the upstream requirements and experiment code are not included.

Verify the vendored bytes with `git hash-object core/finetune/optim/amuse.py`; it must print the blob SHA-1 above.
